                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="core_product" role="tabpanel">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" id="description" rows="3" placeholder="Deskripsi Produk" name="description">{{ old('description', $product->description) }}</textarea>
                                                @error('description')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                                                ...
                                                                <tr >
                                                                    ...
                                                                    <td>
                                                                        <button type="button" class="remove-image border-0 bg-white">
                                                                            <span class="font-22 text-danger"><i class="lni lni-close"></i></span>
                                                                        </button>
                                                                    </td>
                                                                </tr>
                                                                @endforeach
