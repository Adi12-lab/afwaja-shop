<div>
    ...
    <div class="liton__wishlist-area pb-120">
                                ...
                                <div class="col-lg-4">
                                    <div class="ltn__tab-menu-list">
                                        <div class="nav">
                                            ...
                                            <a data-toggle="tab" href="#liton_tab_1_2">Pesanan <i
                                                    class="fas fa-file-alt"></i></a>
                                            <a data-toggle="tab" href="#liton_tab_1_3">Downloads <i
                                                    class="fas fa-arrow-down"></i></a>
                                            <a data-toggle="tab" href="#liton_tab_1_4">Alamat <i
                                                    class="fas fa-map-marker-alt"></i></a>
                                            <a data-toggle="tab" href="#liton_tab_1_5">Detail Akun <i
        ...
        <!-- WISHLIST AREA START -->
        @include("livewire.frontend.user.modal-form")
    </div>
