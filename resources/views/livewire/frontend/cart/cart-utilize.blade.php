 ...
 <div id="ltn__utilize-cart-menu" class="ltn__utilize ltn__utilize-cart-menu">
     <div class="ltn__utilize-menu-inner ltn__scrollbar">
         <div class="ltn__utilize-menu-head">
             <span class="ltn__utilize-menu-title">Keranjang kamu</span>
             <button class="ltn__utilize-close">×</button>
         </div>
         <div class="mini-cart-product-area ltn__scrollbar">
             @if (Auth::check())
                 @forelse($this->cartContent as $cartItem)
                     <div class="mini-cart-item clearfix" wire:key="{{ str()->random(10) }}">
                         <div class="mini-cart-img">
                             ...
                             <button wire:click="removeCartItem({{ $cartItem->id }})" type="button"
                                 class="mini-cart-item-delete" data-toggle="modal" data-target="#add_to_cart_modal">
